...
public class PriorityQueueTester3 {
	...
	public static void main(String[] args) {
		...
		//pq = new SortedListPriorityQueue<String, String>(new StringComparator());    // 2
		//pq = new HeapListPriorityQueue<String, String>(new StringComparator());      // 3
		//pq = new HeapPriorityQueue<String, String>(new StringComparator());          // 4
