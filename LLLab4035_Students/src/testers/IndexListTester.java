...
public class IndexListTester {
	...
	public static void main(String[] args) {	
		...
		//creating another instance of other ADT for excercise 2********
		//listTester("Testing the singly linked list (SLList): ", new LLIndexList<Integer>(new SLFLList<Integer>()));	
		//**************************************************************

		//creating another instance of other ADT for excercise 4********
		//listTester("Testing the doubly linked list (DLDHDTList): ", new LLIndexList<Integer>(new DLDHDTList<Integer>()));	
		//**************************************************************
	}
